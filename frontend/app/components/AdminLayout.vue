      ...
      <nav class="flex flex-col flex-1 w-full gap-2">
        ...
        <div class="w-full">
          <button 
            ...
            class="flex items-center justify-between w-full px-2 py-0.5 mb-0.5 text-xs font-semibold text-gray-400 uppercase tracking-wider hover:text-admin transition-colors"
          >
            ...
            <transition enter-active-class="transition duration-200 ease-out" enter-from-class="transform scale-95 opacity-0" enter-to-class="transform scale-100 opacity-100" leave-active-class="transition duration-150 ease-in" leave-from-class="transform scale-100 opacity-100" leave-to-class="transform scale-95 opacity-0">
              <div v-if="dropdownOpen" class="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50" style="top: calc(100% + 8px)">
                <div class="px-4 py-3 border-b border-gray-100">
                  <p class="text-sm font-semibold text-gray-800">{{ admin.firstName }} {{ admin.lastName }}</p>
                  <p class="text-xs text-blacky mt-0.5 font-medium">Directeur</p>
                  <p class="text-xs text-gray-400 mt-0.5">{{ currentUser?.email }}</p>
                </div>
                <nuxt-link to="/directeurs/profile" @click="closeDropdown" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-blacky/10 hover:text-blacky transition-colors">
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                  Mon profil
                </nuxt-link>
                <nuxt-link to="/directeurs/parametres" @click="closeDropdown" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-blacky/10 hover:text-blacky transition-colors">
    ...
    <nav class="md:hidden fixed bottom-0 left-0 right-0 z-50">
      <div class="w-full bg-white shadow-[0_-1px_2px_1px_rgba(0,0,0,0.10)]">
        <div class="grid grid-cols-5 h-16">
          ...
          <nuxt-link to="/directeurs/users" class="flex flex-col items-center justify-center gap-0.5 transition-colors" :class="$route.path === '/directeurs/users' ? 'text-blacky' : 'text-gray-400'">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
            <span class="text-[10px] font-medium">Utilisateurs</span>
          </nuxt-link>

          <nuxt-link to="/directeurs/invitations" class="flex flex-col items-center justify-center gap-0.5 transition-colors" :class="$route.path === '/directeurs/invitations' ? 'text-blacky' : 'text-gray-400'">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
            <span class="text-[10px] font-medium">Invitations</span>
          </nuxt-link>

          <nuxt-link to="/directeurs/structure" class="flex flex-col items-center justify-center gap-0.5 transition-colors" :class="$route.path === '/directeurs/structure' ? 'text-blacky' : 'text-gray-400'">
        ...
        >
          <div v-if="mobileMenuOpen" class="border-t border-gray-100 grid grid-cols-4 py-3 px-2 gap-2">
            <nuxt-link to="/directeurs/sessions" @click="mobileMenuOpen = false" class="flex flex-col items-center justify-center gap-1 py-2 rounded-xl hover:bg-gray-50 transition-colors" :class="$route.path === '/directeurs/sessions' ? 'text-blacky' : 'text-gray-500'">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
              <span class="text-[10px] font-medium">Sessions</span>
            </nuxt-link>

            <nuxt-link to="/directeurs/ecole" @click="mobileMenuOpen = false" class="flex flex-col items-center justify-center gap-1 py-2 rounded-xl hover:bg-gray-50 transition-colors" :class="$route.path === '/directeurs/ecole' ? 'text-blacky' : 'text-gray-500'">
            ...
            <nuxt-link to="/directeurs/profile" @click="mobileMenuOpen = false" class="flex flex-col items-center justify-center gap-1 py-2 rounded-xl hover:bg-gray-50 transition-colors" :class="$route.path === '/directeurs/profile' ? 'text-blacky' : 'text-gray-500'">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
              <span class="text-[10px] font-medium">Profil</span>
            </nuxt-link>

            <nuxt-link to="/directeurs/parametres" @click="mobileMenuOpen = false" class="flex flex-col items-center justify-center gap-1 py-2 rounded-xl hover:bg-gray-50 transition-colors" :class="$route.path === '/directeurs/parametres' ? 'text-blacky' : 'text-gray-500'">
