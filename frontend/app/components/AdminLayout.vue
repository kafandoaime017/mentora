      ...
      <nav class="flex flex-col flex-1 w-full gap-2">
        ...
        <div class="w-full">
          <button 
            ...
            class="flex items-center justify-between w-full px-2 py-0.5 mb-0.5 text-xs font-semibold text-black uppercase tracking-wider hover:text-admin transition-colors"
          >
            <span class="text-primary">Navigation</span>
            <svg 
              class="w-3 h-3 transition-transform duration-200" 
              :class="{ 'rotate-180': collapsedSections.main }"
              fill="none" 
              stroke="currentColor" 
              viewBox="0 0 24 24"
            >
        ...
        <div class="w-full mt-1">
          ...
          >
            ...
            <svg 
              class="w-3 h-3 transition-transform duration-200" 
              :class="{ 'rotate-180': collapsedSections.gestion }"
              fill="none" 
              stroke="currentColor" 
              viewBox="0 0 24 24"
            >
        ...
        <div class="w-full mt-1">
          <button 
            v-if="!sidebarCollapsed"
            @click="toggleCollapse('personnel')"
            class="flex items-center justify-between w-full px-2 py-0.5 mb-0.5 text-xs font-semibold text-black uppercase tracking-wider hover:text-admin transition-colors"
          >
            <span class="text-primary">Personnel</span>
            <svg 
              class="w-3 h-3 transition-transform duration-200" 
              :class="{ 'rotate-180': collapsedSections.personnel }"
              fill="none" 
              stroke="currentColor" 
              viewBox="0 0 24 24"
            >
          ...
          <transition 
            ...
            @leave="leave"
          >
            <div v-show="!sidebarCollapsed ? !collapsedSections.personnel : true" class="space-y-0.5">
              <nuxt-link
              ...
              <div v-if="notifOpen" class="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-md border border-gray-100 z-50 overflow-hidden" style="top: calc(100% + 8px)">
                <div class="flex items-center justify-between px-4 py-3 border-b border-gray-100">
                  ...
                  <div class="flex gap-3">
                    <button v-if="unreadCount > 0" @click="markAllRead" class="text-xs text-blacky hover:text-[#312e81] transition-colors font-medium">Tout lire</button>
                ...
                <div class="max-h-72 overflow-y-auto">
                  ...
                  >
                    <div class="shrink-0 w-8 h-8 rounded-full flex items-center justify-center bg-blue-100 text-blue-600">
            ...
            <transition enter-active-class="transition duration-200 ease-out" enter-from-class="transform scale-95 opacity-0" enter-to-class="transform scale-100 opacity-100" leave-active-class="transition duration-150 ease-in" leave-from-class="transform scale-100 opacity-100" leave-to-class="transform scale-95 opacity-0">
              <div v-if="dropdownOpen" class="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-md border border-gray-100 py-2 z-50" style="top: calc(100% + 8px)">
                <div class="px-4 py-3 border-b border-gray-100">
                  <p class="text-sm font-semibold text-black">{{ admin.firstName }} {{ admin.lastName }}</p>
                  <p class="text-xs text-blacky mt-0.5 font-medium">Directeur</p>
                  <p class="text-xs text-black mt-0.5">{{ currentUser?.email }}</p>
                </div>
                <nuxt-link to="/directeurs/profile" @click="closeDropdown" class="flex items-center gap-3 px-4 py-2.5 text-sm text-black hover:bg-blacky/10 hover:text-blacky transition-colors">
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                  Mon profil
                </nuxt-link>
                <nuxt-link to="/directeurs/parametres" @click="closeDropdown" class="flex items-center gap-3 px-4 py-2.5 text-sm text-black hover:bg-blacky/10 hover:text-blacky transition-colors">
    ...
    <nav class="md:hidden fixed bottom-0 left-0 right-0 z-50">
      <div class="w-full bg-white shadow-[0_-1px_2px_1px_rgba(0,0,0,0.10)]">
        <div class="grid grid-cols-5 h-16">
          <nuxt-link to="/directeurs" class="flex flex-col items-center justify-center gap-0.5 transition-colors" :class="$route.path === '/directeurs' ? 'text-blacky' : 'text-black'">
          ...
          <nuxt-link to="/directeurs/users" class="flex flex-col items-center justify-center gap-0.5 transition-colors" :class="$route.path === '/directeurs/users' ? 'text-blacky' : 'text-black'">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
            <span class="text-[10px] font-medium">Utilisateurs</span>
          </nuxt-link>

          <nuxt-link to="/directeurs/invitations" class="flex flex-col items-center justify-center gap-0.5 transition-colors" :class="$route.path === '/directeurs/invitations' ? 'text-blacky' : 'text-black'">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
            <span class="text-[10px] font-medium">Invitations</span>
          </nuxt-link>

          <nuxt-link to="/directeurs/structure" class="flex flex-col items-center justify-center gap-0.5 transition-colors" :class="$route.path === '/directeurs/structure' ? 'text-blacky' : 'text-black'">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
            <span class="text-[10px] font-medium">Structure</span>
          </nuxt-link>
        ...
        >
          <div v-if="mobileMenuOpen" class="border-t border-gray-100 grid grid-cols-3 py-3 px-2 gap-2">
            <nuxt-link to="/directeurs/sessions" @click="mobileMenuOpen = false" class="flex flex-col items-center justify-center gap-1 py-2 rounded-lg hover:bg-gray-50 transition-colors" :class="$route.path === '/directeurs/sessions' ? 'text-blacky' : 'text-black'">
            ...
            <nuxt-link to="/directeurs/audit-logs" @click="mobileMenuOpen = false" class="flex flex-col items-center justify-center gap-1 py-2 rounded-lg hover:bg-gray-50 transition-colors" :class="$route.path === '/directeurs/audit-logs' ? 'text-blacky' : 'text-black'">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
              <span class="text-[10px] font-medium">Logs d'audit</span>
            </nuxt-link>

            <nuxt-link to="/directeurs/profile" @click="mobileMenuOpen = false" class="flex flex-col items-center justify-center gap-1 py-2 rounded-lg hover:bg-gray-50 transition-colors" :class="$route.path === '/directeurs/profile' ? 'text-blacky' : 'text-black'">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
              <span class="text-[10px] font-medium">Profil</span>
            </nuxt-link>

            <nuxt-link to="/directeurs/parametres" @click="mobileMenuOpen = false" class="flex flex-col items-center justify-center gap-1 py-2 rounded-lg hover:bg-gray-50 transition-colors" :class="$route.path === '/directeurs/parametres' ? 'text-blacky' : 'text-black'">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
...
const sidebarCollapsedState = useCookie('sidebar_collapsed_state', {
  default: () => false,
  maxAge: 365 * 24 * 60 * 60,
  sameSite: 'lax'
})
...
const loadSavedStates = () => {
  ...
  if (savedSidebarState !== undefined && savedSidebarState !== null) {
  ...
  if (savedCollapsedState && typeof savedCollapsedState === 'object') {
    collapsedSections.value = {
      ...
      personnel: savedCollapsedState.personnel || false,
...
const saveSidebarState = () => {
  sidebarStateCookie.value = sidebarCollapsed.value
}

// Sauvegarder l'état des collapses
const saveCollapsedState = () => {
  sidebarCollapsedState.value = {
    main: collapsedSections.value.main,
    gestion: collapsedSections.value.gestion,
    personnel: collapsedSections.value.personnel,
    compte: collapsedSections.value.compte
  }
}

// Toggle sidebar avec sauvegarde
const toggleSidebar = () => {
...
// Surveiller les changements d'état des collapses
watch(collapsedSections, () => {
  saveCollapsedState()
}, { deep: true })

// Fonctions d'animation pour les collapses
const enter = (el) => {
  el.style.height = '0'
  el.style.opacity = '0'
...
onBeforeMount(() => { 
  currentUser.value = getUser()
  loadSavedStates() // Charger les états sauvegardés
})
...
// Séparation des items en catégories
const mainNavItems = [
  {
    key: 'home', to: '/directeurs', label: 'Tableau de bord',
    icon: () => h('svg', { width: 20, height: 20, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', 'stroke-width': 2 }, [
      h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', d: 'M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z' }),
      h('polyline', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', points: '9 22 9 12 15 12 15 22' })
    ])
  },
...
const gestionNavItems = [
  {
    key: 'invitations', to: '/directeurs/invitations', label: 'Invitations',
    icon: () => h('svg', { width: 20, height: 20, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', 'stroke-width': 2 }, [
  ...
  {
    key: 'users', to: '/directeurs/users', label: 'Utilisateurs',
    icon: () => h('svg', { width: 20, height: 20, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', 'stroke-width': 2 }, [
  ...
  {
    key: 'structure', to: '/directeurs/structure', label: 'Filières & Classes',
    icon: () => h('svg', { width: 20, height: 20, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', 'stroke-width': 2 }, [
  ...
  {
    key: 'sessions', to: '/directeurs/sessions', label: 'Sessions',
    icon: () => h('svg', { width: 20, height: 20, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', 'stroke-width': 2 }, [
      h('rect', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', x: 3, y: 4, width: 18, height: 18, rx: 2 }),
  ...
  {
    key: 'create-session', to: '/directeurs/create-session', label: 'Créer session (urgence)',
    icon: () => h('svg', { width: 20, height: 20, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', 'stroke-width': 2 }, [
      h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', d: 'M13 10V3L4 14h7v7l9-11h-7z' })
    ])
  },
  {
    key: 'calendrier', to: '/directeurs/calendrier', label: 'Calendrier',
    icon: () => h('svg', { width: 20, height: 20, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', 'stroke-width': 2 }, [
      h('rect', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', x: 3, y: 4, width: 18, height: 18, rx: 2 }),
      h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', d: 'M16 2v4M8 2v4M3 10h18' })
    ])
  },
  {
    key: 'annonces', to: '/directeurs/annonces', label: 'Annonces & sondages',
    icon: () => h('svg', { width: 20, height: 20, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', 'stroke-width': 2 }, [
  ...
  {
    key: 'audit-logs', to: '/directeurs/audit-logs', label: "Logs d'audit",
    icon: () => h('svg', { width: 20, height: 20, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', 'stroke-width': 2 }, [
...
const personnelNavItems = [
  {
    key: 'ecole', to: '/directeurs/ecole', label: 'Mon établissement',
    icon: () => h('svg', { width: 20, height: 20, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', 'stroke-width': 2 }, [
  ...
  {
    key: 'abonnement', to: '/directeurs/abonnement', label: 'Abonnement',
    icon: () => h('svg', { width: 20, height: 20, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', 'stroke-width': 2 }, [
