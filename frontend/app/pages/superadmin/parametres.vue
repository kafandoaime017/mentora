        ...
        <template v-else>
          ...
          <div class="bg-white border border-gray-200 rounded-lg overflow-hidden mb-4">
            <div class="p-4 border-b border-gray-100">
              ...
              <p class="text-sm text-black font-body mt-0.5">Un son joue quand une notification arrive en direct</p>
            </div>

            <div class="divide-y divide-gray-50">
              <div class="flex items-center justify-between p-4">
                <div>
                  <p class="text-sm font-semibold text-black font-body">Son actif</p>
                  <p class="text-sm text-black font-body mt-0.5">Désactivez pour ne jouer aucun son</p>
                </div>
                <button @click="toggle('notifSonActif')"
              ...
              <div class="p-4">
                <p class="text-sm font-semibold text-black font-body mb-1">Son personnalisé</p>
                <p class="text-sm text-black font-body mb-3">
                  {{ settings.notifSonUrl ? 'Un son personnalisé est actif.' : "Aucun son personnalisé - le carillon par défaut est utilisé." }}
                </p>
                <div class="flex flex-wrap gap-2">
                  <button @click="testerSon" class="px-4 py-2 bg-gray-100 text-black rounded-lg text-sm font-body font-semibold hover:bg-gray-200 transition">
                    Tester
                  </button>
                  <label class="px-4 py-2 bg-gray-100 text-black rounded-lg text-sm font-body font-semibold hover:bg-gray-200 transition cursor-pointer">
                  ...
                  <button v-if="settings.notifSonUrl" @click="reinitialiserSon" class="px-4 py-2 border border-red-300 text-red-500 rounded-lg text-sm font-body font-semibold hover:bg-red-50 transition">
                    Réinitialiser
                  </button>
                </div>
              </div>
              ...
              <div v-if="!settings.totpEnabled">
                <div class="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-black font-body mt-0.5">Activez pour sécuriser votre compte avec Google Authenticator, Microsoft Authenticator ou Authy</p>
                  </div>
                </div>
                <button
              ...
              <div v-else>
                <div class="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-black font-body mt-0.5">Votre compte est protégé par authentification à deux facteurs</p>
                  </div>
                </div>
                <button
