      ...
      <div v-else>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-6">
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
            <nuxt-link to="/superadmin/ecoles"
              class="flex flex-col items-center gap-2 p-4 bg-blue-50 hover:bg-blue-100 rounded-xl transition-colors"
            >
            ...
            <nuxt-link to="/superadmin/directeurs"
              class="flex flex-col items-center gap-2 p-4 bg-purple-50 hover:bg-purple-100 rounded-xl transition-colors"
            >
            ...
            <nuxt-link to="/superadmin/ecoles"
              class="flex flex-col items-center gap-2 p-4 bg-amber-50 hover:bg-amber-100 rounded-xl transition-colors"
            >
            ...
            <nuxt-link to="/superadmin/users"
              class="flex flex-col items-center gap-2 p-4 bg-green-50 hover:bg-green-100 rounded-xl transition-colors"
            >
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            ...
            <nuxt-link to="/superadmin/directeurs" class="text-xs text-[#0f172a] font-semibold hover:underline">Voir tout →</nuxt-link>
          </div>
...
const statCards = computed(() => {
  ...
  return [
    { label: 'Écoles',       value: statsData.value.totalEcoles,     bg: 'bg-blue-50',   color: 'text-blue-600',   path: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5' },
    { label: 'Directeurs',   value: statsData.value.totalDirecteurs, bg: 'bg-purple-50', color: 'text-purple-600', path: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
    { label: 'Professeurs',  value: statsData.value.totalProfs,      bg: 'bg-red-50',    color: 'text-red-600',    path: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13' },
    { label: 'Étudiants',    value: statsData.value.totalEtudiants,  bg: 'bg-green-50',  color: 'text-green-600',  path: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
    { label: 'Sessions',     value: statsData.value.totalSessions,   bg: 'bg-amber-50',  color: 'text-amber-600',  path: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2' },
