        ...
        <div class="bg-white border border-[#e2ddd4] rounded-lg overflow-hidden">
          ...
          <div class="border-b font-body border-gray-200">
            <div class="p-4 flex items-center justify-between">
              ...
              <button @click="ouvrirModalModification('nom')" class="text-[#4a7c5e] bg-[#e2ddd4] hover:text-[#1e3a2f] transition-colors p-2 rounded-full hover:bg-[#e2ddd4]/80">
          ...
          <div class="border-b font-body border-gray-200">
            <div class="p-4 flex items-center justify-between">
              ...
              <button @click="ouvrirModalModification('prenom')" class="text-[#4a7c5e] bg-[#e2ddd4] hover:text-[#1e3a2f] transition-colors p-2 rounded-full hover:bg-[#e2ddd4]/80">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                </svg>
              </button>
...
function onAvatarPickerDone(newAvatar) {
  ...
  // Recharge la page pour que le header (état séparé dans AdminLayout) reflète le nouvel avatar
