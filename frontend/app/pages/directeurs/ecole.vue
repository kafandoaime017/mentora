  ...
  <div class="bg-layout font-body min-h-screen">
    <AdminLayout>
      <div class="max-w-2xl mx-auto">
       ...
       <!--    <div class="bg-white rounded-lg shadow-[1px_1px_7px_1px_rgba(0,0,0,0.08)] p-6">
            <h3 class="font-bold font-body text-black mb-4">Logo de l'établissement</h3>
            <div class="flex items-center gap-4">
              <div class="w-20 h-20 rounded-lg border-2 border-dashed border-gray-200 flex items-center justify-center overflow-hidden bg-gray-50">
              ...
              <div>
                <p class="text-sm text-black mb-2">URL du logo</p>
                <input
                  v-model="form.logo"
                  type="text"
                  placeholder="https://..."
                  class="w-full px-3 py-2 bg-input rounded-lg text-sm font-body focus:outline-none"
                />
              </div>
            </div>
          </div> -->
