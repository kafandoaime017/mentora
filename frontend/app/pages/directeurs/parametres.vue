              ...
              <div v-if="!settings.totpEnabled">
                <div class="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-500 font-body mt-0.5">Activez pour sécuriser votre compte avec Google
              ...
              <div v-else>
                <div class="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-gray-400 font-body mt-0.5">Votre compte est protégé par authentification à
                      deux facteurs</p>
                  </div>
                </div>
            ...
            <div class="p-5">
              ...
              <div v-else-if="totpStep === 2" class="space-y-4">
                ...
                <input v-model="totpCode" type="text" inputmode="numeric" maxlength="6" placeholder="000000"
                  ...
                  autofocus />
                <div v-if="totpErreur"
                  class="bg-red-50 text-red-600 text-xs font-body rounded-xl px-4 py-2 text-center">
                  {{ totpErreur }}
                </div>
                <div class="flex gap-3">
                  <button @click="totpStep = 1; totpErreur = ''"
                    class="flex-1 py-2.5 bg-gray-100 text-gray-600 rounded-xl text-sm font-body font-semibold hover:bg-gray-200 transition">Retour</button>
          ...
          <div class="bg-white rounded-xl shadow-xl max-w-sm w-full">
            ...
            <div class="p-5 space-y-4">
              ...
              <input v-model="totpDesactiverCode" type="text" inputmode="numeric" maxlength="6" placeholder="000000"
                ...
                class="w-full px-4 py-1 bg-input rounded-xl text-center text-2xl font-mono font-bold tracking-[0.4em] focus:outline-none"
                autofocus />
              ...
              <div class="flex gap-3">
                <button @click="modalDesactiver2FAVisible = false; totpErreur = ''"
                  class="flex-1 py-2.5 bg-gray-100 text-gray-600 rounded-xl text-sm font-body font-semibold hover:bg-gray-200 transition">Annuler</button>
