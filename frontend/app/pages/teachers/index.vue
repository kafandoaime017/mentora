        ...
        <div v-else>
          ...
          <div class="bg-white rounded-xl shadow overflow-hidden">
            ...
            <div v-if="statsData.sessionsAVenir?.length === 0" class="p-12 text-center text-[#9b9589]">
              ...
              <NuxtLink to="/teacher/qcm/create" class="text-[#4a7c5e] font-body hover:underline text-sm mt-2 inline-block">
                Créer une session →
              </NuxtLink>
            </div>
            ...
            <div v-else class="divide-y divide-[#e2ddd4]">
              <div 
                ...
                @click="navigateTo(`/teacher/qcm/${session.id}`)"
              >
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <button 
                      @click.stop="navigateTo(`/teacher/qcm/${session.id}/edit`)"
